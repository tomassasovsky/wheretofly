...
// Permission *levels* (PermissionLevel ids) that may operate in these zones —
// must match ZonePermissionIds in package:zones_api_client, NOT the zone
// category id. Controlled airspace: Specific-Category authorization or
// case-by-case tower coordination. Restricted: site clearance only.
const Set<String> _ctrlPerms = {'authorized_commercial', 'special_permit'};
const Set<String> _restrictPerms = {'special_permit'};
...
const List<AipZoneEntry> zoneDatabase = [
  ...
  AipZoneEntry(
    ...
    details:
        'Terminal Manoeuvring Area Buenos Aires. Class C. '
  ...
  AipZoneEntry(
    ...
    details:
        'CTR Aeropuerto Internacional Ezeiza (SAEZ). Clase D. '
  ...
  AipZoneEntry(
    ...
    details:
        'CTR Aeroparque Jorge Newbery (SABE). Clase D. '
        'Drones prohibidos sin autorización.',
    // Límites laterales — from SABE AD 2.17 (AMDT AIRAC 3/2019).
    // Two edges are shared limits, traced via canonical polylines so they line
    // up with neighbours (see SharedBoundary): the eastern edge follows the
    // FIR EZEIZA/MONTEVIDEO limit (shared with TMA BAIRES), and the southern
    // edge follows the CTR EZEIZA perimeter (vertices 343658/343810/343734 are
    // verbatim CTR EZEIZA points; the approach vertex 344528S-0581802W is
    // rounded ~0.4 NM off it in AD 2.17, so we snap onto the shared line).
    boundaryText:
        '''
      341846S-0584608W,
      ...
      343058S-0580202W, 344528S-0581802W,
      siguiendo el límite CTR EZEIZA hasta 343734S-0584308W,
      342346S-0584750W
      hasta 341846S-0584608W.
    ''',
  ),
  ...
  AipZoneEntry(
    ...
    details:
        'Zona Restringida SAR 01 Capital Federal. '
