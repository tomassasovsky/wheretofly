...
/// Open-Meteo file-format WASM loader for CLI smoke tests (no Flutter assets).
abstract final class OmWasmModule {
  ...
  static void setI64(int ptr, int value) {
    final view = ByteData.sublistView(heap, ptr, ptr + 8);
