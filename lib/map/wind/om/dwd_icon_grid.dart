...
class DwdIconTileRead {
  ...
  // ignore: prefer_constructors_over_static_methods, named factories read clearer.
  ...
  static List<OmDimensionRange> _xSegmentsForBounds({
    ...
    // Slippy-map tile crosses the antimeridian (east lon is west of -180°).
  ...
  /// Grid view for sampling decoded values (supports stitched x segments).
  DwdIconGrid toGrid() {
    final south = tile2lat(y + 1, z);
    final north = tile2lat(y.toDouble(), z);
    final west = tile2lon(x.toDouble(), z);
  ...
  /// Reads and horizontally stitches OM slices for this tile.
